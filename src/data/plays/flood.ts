  ...
  steps: [
    {
      ...
      narrative: {
        ...
        C4: "You're isolated on the far side — the continuation target once the first cut connects.",
      },
    },
    {
      id: 'flood-2-clear',
      label: 'C2 and C3 Clear to the Corner',
      force: 'none',
      players: [
        { id: 'H1', x: 0.486, y: 0.455, hasDisc: true },
        { id: 'H2', x: 0.127, y: 0.455 },
      ...
      narrative: {
        H1: "C2 and C3 are clearing hard toward the corner, emptying the middle of the field for the first cut.",
        ...
        C4: "Stay isolated on the far side — don't drift into the space about to open up.",
    ...
    },
    {
      ...
      narrative: {
        ...
        C4: "Stay alert — you're next if C1 connects.",
    ...
    },
    {
      ...
      players: [
        ...
        { id: 'C2', x: 0.09, y: 0.20 },
        { id: 'C3', x: 0.14, y: 0.16 },
        { id: 'C4', x: 0.810, y: 0.328, hasDisc: true },
        { id: 'H1', x: 0.486, y: 0.400, isDefense: true },
        { id: 'H2', x: 0.127, y: 0.400, isDefense: true },
        { id: 'H3', x: 0.794, y: 0.432, isDefense: true },
        { id: 'C1', x: 0.54, y: 0.225, isDefense: true },
