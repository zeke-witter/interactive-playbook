  ...
  steps: [
    {
      ...
      force: 'none',
      players: [
        { id: 'H1', x: 0.486, y: 0.915, hasDisc: true },
        { id: 'H2', x: 0.127, y: 0.8875 },
        { id: 'H3', x: 0.794, y: 0.970 },
        { id: 'C1', x: 0.095, y: 0.478 },
        { id: 'C2', x: 0.302, y: 0.478 },
        { id: 'C3', x: 0.556, y: 0.478 },
        { id: 'C4', x: 0.810, y: 0.478 },
        { id: 'H1', x: 0.406, y: 0.905, isDefense: true },
        { id: 'H2', x: 0.157, y: 0.8325, isDefense: true },
        { id: 'H3', x: 0.764, y: 0.915, isDefense: true },
        { id: 'C1', x: 0.140, y: 0.423, isDefense: true },
        { id: 'C2', x: 0.347, y: 0.533, isDefense: true },
        { id: 'C3', x: 0.601, y: 0.533, isDefense: true },
        { id: 'C4', x: 0.765, y: 0.533, isDefense: true },
      ],
      pathPreviews: [],
      narrative: {
    ...
    },
    {
      ...
      players: [
        ...
        { id: 'H3', x: 0.764, y: 0.915, isDefense: true },
        { id: 'C1', x: 0.140, y: 0.423, isDefense: true },
        { id: 'C2', x: 0.065, y: 0.395, isDefense: true },
        { id: 'C3', x: 0.095, y: 0.275, isDefense: true },
        { id: 'C4', x: 0.125, y: 0.155, isDefense: true },
      ],
      pathPreviews: [
        { playerId: 'C2', points: [{ x: 0.302, y: 0.478 }, { x: 0.02, y: 0.34 }], type: 'clear' },
        { playerId: 'C3', points: [{ x: 0.556, y: 0.478 }, { x: 0.05, y: 0.22 }], type: 'clear' },
        { playerId: 'C4', points: [{ x: 0.810, y: 0.478 }, { x: 0.08, y: 0.10 }], type: 'clear' },
      ],
      narrative: {
    ...
    },
    {
      ...
      players: [
        ...
        { id: 'H2', x: 0.157, y: 0.8325, isDefense: true },
        { id: 'H3', x: 0.764, y: 0.915, isDefense: true },
        { id: 'C1', x: 0.585, y: 0.44, isDefense: true },
        { id: 'C2', x: 0.065, y: 0.395, isDefense: true },
        { id: 'C3', x: 0.095, y: 0.275, isDefense: true },
        { id: 'C4', x: 0.125, y: 0.155, isDefense: true },
      ],
      pathPreviews: [
        { playerId: 'C1', points: [{ x: 0.095, y: 0.478 }, { x: 0.51, y: 0.325 }, { x: 0.54, y: 0.495 }], type: 'primary' },
      ],
      throw: { from: 'H1', to: 'C1' },
      narrative: {
    ...
    },
    {
      ...
      force: 'none',
      players: [
        { id: 'H1', x: 0.486, y: 0.915 },
        { id: 'H2', x: 0.127, y: 0.8875 },
        { id: 'H3', x: 0.794, y: 0.970 },
        { id: 'C1', x: 0.54, y: 0.495, hasDisc: true },
        { id: 'C2', x: 0.02, y: 0.34 },
        { id: 'C3', x: 0.05, y: 0.22 },
        { id: 'C4', x: 0.38, y: 0.40 },
        { id: 'H1', x: 0.406, y: 0.905, isDefense: true },
        ...
        { id: 'C2', x: 0.065, y: 0.395, isDefense: true },
        { id: 'C3', x: 0.095, y: 0.275, isDefense: true },
        { id: 'C4', x: 0.425, y: 0.345, isDefense: true },
      ],
      pathPreviews: [
        { playerId: 'C4', points: [{ x: 0.08, y: 0.10 }, { x: 0.38, y: 0.40 }], type: 'primary' },
      ],
      throw: { from: 'C1', to: 'C4' },
      narrative: {
    ...
    },
    {
      ...
      players: [
        ...
        { id: 'C2', x: 0.02, y: 0.34 },
        { id: 'C3', x: 0.05, y: 0.22 },
        { id: 'C4', x: 0.38, y: 0.40, hasDisc: true },
        { id: 'H1', x: 0.406, y: 0.905, isDefense: true },
        { id: 'H2', x: 0.157, y: 0.8325, isDefense: true },
        { id: 'H3', x: 0.764, y: 0.915, isDefense: true },
        { id: 'C1', x: 0.585, y: 0.44, isDefense: true },
