...
export const hoStackCenter: Play = {
  ...
  steps: [
    ...
    },
    {
      ...
      pathPreviews: [
        { playerId: 'C3', points: [{ x: 0.556, y: 0.263 }, { x: 0.45, y: 0.42 }], type: 'primary' },
        { playerId: 'C2', points: [{ x: 0.302, y: 0.263 }, { x: 0.35, y: 0.18 }], type: 'clear' },
      ],
      narrative: {
