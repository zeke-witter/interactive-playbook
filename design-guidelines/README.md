...
## Files
- `Designer Layout Options.dc.html` — the full set of mockups referenced above. Open in a browser to view all options; section/option ids referenced in this doc (1a, 2a, 3a, 4a, 4b, 5a, 5b, 6a, 6b, 7a, 7b) are anchor-linkable within that file (e.g. jump to `#6a`).
- `screenshots/` — one PNG per option, named to match its id (`1a.png`, `1b.png`, `2a.png`, `3a.png`, `4a.png`, `4b.png`, `5a.png`, `5b.png`, `6a.png`, `6b.png`, `7a.png`, `7b.png`), for quick reference without opening the HTML file.
